...
<div id="root">
    ...
    <div class="link-top-container">
        ...
        <a href="./barrage-passed.jsp" class="link-top-item active">
            <span>已通过</span>
        </a>
...
<%--            <form action="#" method="post" id="tableList">--%>
                ...
                <table class="hovertable" id="table"
                    ...
                    <%
                        ...
                        ArrayList<Barrage> barrages = dao.getBarrageByVideoId(2, videoId);
                    ...
                    <c:forEach items="${barrages}" var="thisbarrage">
                        <tr>
                            ...
                            <td style="text-align: center">
                                <button onclick="delRow(this)" value="${thisbarrage.barrageId}" class="btn3">撤销
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
