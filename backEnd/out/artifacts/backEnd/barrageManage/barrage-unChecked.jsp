...
<div id="root">
    ...
    <div class="link-top-container">
        <a href="./barrage-unChecked.jsp" class="link-top-item active">
            <span>待审核</span>
        </a>
        <a href="./barrage-passed.jsp" class="link-top-item">
            <span>已通过</span>
        </a>
        <a href="./barrage-unpassed.jsp" class="link-top-item">
            <span>未通过</span>
        </a>
    </div>
    <%--    主体中间部分--%>
...
<%--            <form action="#" method="post" id="tableList">--%>
                ...
                <table class="hovertable" id="table"
                    ...
                    <%
                        ...
                        ArrayList<Barrage> barrages = dao.getBarrageByVideoId(1, videoId);
                    ...
                    <c:forEach items="${barrages}" var="thisbarrage">
                        <tr>
                            ...
                            <td style="text-align: center">
                                <button onclick="passRow(this)" value="${thisbarrage.barrageId}" class="btn1">通过
                                </button>
                                <button onclick="unpassRow(this)" value="${thisbarrage.barrageId}" class="btn2">不通过
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
