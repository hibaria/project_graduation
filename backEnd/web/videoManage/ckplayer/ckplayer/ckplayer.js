...
!(function () {
    ...
    var ckplayer = function (obj) {
		...
		*/
        ...
        this.contextMenu = [
            // ['弹幕管理', 'link', 'http://localhost:8080/BarrageProject/barrageManage/barrage-unChecked.jsp'],
    ...
    ckplayer.prototype = {
		...
		*/
        ...
        /*
			...
			向播放器界面添加一个文本
		*/
        addElement: function (attribute, barrageType, duration) {
            var thisTemp = this;
            if (this.playerType == 'flashplayer') {
            ...
            if(barrageType==="normal")
                document.getElementById("barrageDiv").appendChild(ele);
            else
                this.PD.appendChild(ele);
            var eid = this.getByElement(id);
            // 根据普通弹幕、气泡弹幕、表情、图片优先级设置z-index
            switch (barrageType) {
                case "normal":
                    this.css(eid, {
                        position: 'absolute',
                ...
                case "emoji_top":
                    this.css(eid, {
                        ...
                        width: '800px',
                        zIndex: '22',
                        // animation: 'emoji-top 3s infinite',
                ...
                case "img_center":
                    this.css(eid, {
                        ...
                        width: '800px',
                        zIndex: '31',
                        animation: 'ani-full-screen ' + duration + 's infinite',
                        animationTimingFunction: 'linear'
                    });
                    break;
                case "img":
		...
		*/
        deleteElement: function (ele) {
            ...
            // this.deleteAnimate(ele);不要删除啊！因为删了的话当前屏幕中的弹幕都会删掉
            this.deleteChild(ele);

        },
        deleteAllElement: function (ele) {
            if (this.playerType == 'flashplayer' && this.V) {
                try {
                    this.V.deleteElement(ele);
                } catch (event) {
